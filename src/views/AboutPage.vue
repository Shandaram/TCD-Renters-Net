<template>
    <div class="main-container">
        <!-- first block -->
        <div class="l-block">
            <LandingText title="About us" subTitle="Who are we?" txt="TCD Renters Solidarity Network is a grassroot group of Trinity student tenants that aims to coordinate campaigns around the collective issues we face. We aim to campaign to challenge the restrictive and paternalistic overnight guests policy, advocate for free laundry machines and stand up against unaffordable rents, as well as to coordinate Palestinian solidarity such as flag drops. 
